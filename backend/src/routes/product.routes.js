...
router.post('/', verifyToken, authorize('admin', 'vendedor'), wrap(productController.create));
router.put('/:id', verifyToken, authorize('admin', 'vendedor'), wrap(productController.update));
